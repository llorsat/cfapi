...
var fileSettings = fs.readFileSync('../settings.js');
var fileString = fileSettings.toString();
var settings = JSON.parse(fileString);
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        min:{
            dist:{
                src: ['../deploy/_main_prototype_.js'],
                dest: '../deploy/main.js'
            }
        },
        ...
        i18n: {
            dist: {
                languages: settings.i18n.languages || ["en"],
                src: '.',
                blacklist: settings.i18n.blacklist || [],
                whitelist: settings.i18n.files || [],
                dest: 'public',
                variables: {
